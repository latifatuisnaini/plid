...
class InfoLayananPublik1Controller extends Controller
{
    public function index(){
        ...
        ->where('kategori_dokumen.ID_JENIS_KATEGORI','=',2)
        ...
        return view('info_layanan_publik_1', compact('kategori_dokumen'));
    } 
    public function show($id){
        $info1 = Dokumen::find($id);
        
        return Storage::disk('public')->download('dokumen/'.$info1->LINK_FILE);
