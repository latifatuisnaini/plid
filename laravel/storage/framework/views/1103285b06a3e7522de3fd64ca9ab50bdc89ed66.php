...
<html lang="en" class="light">
    ...
    <body class="app">
        ...
        <div class="mobile-menu md:hidden">
            <div class="mobile-menu-bar">
                <a href="" class="flex mr-auto">
                    <img alt="Midone Tailwind HTML Admin Template" src="<?php echo e(asset('dist/images/logo_pt_pal_putih.png')); ?>" style="width:7rem;">
                </a>
                <a href="javascript:;" id="mobile-menu-toggler"> <i data-feather="bar-chart-2" class="w-8 h-8 text-white transform -rotate-90"></i> </a>
            </div>
            <ul class="border-t border-theme-24 py-5 hidden">
                <li>
                    <a href="<?php echo e(url('/beranda')); ?>" class="menu menu--active">
                ...
                <li>
                    <a href="<?php echo e(url('/profil')); ?>" class="menu menu--active">
                        <div class="menu__icon">  </div>
                ...
                <li>
                    <a href="<?php echo e(url('/regulasi')); ?>" class="menu menu--active">
                        <div class="menu__icon">  </div>
                ...
                <li>
                    <a href="<?php echo e(url('/maklumat')); ?>" class="menu menu--active">
                        <div class="menu__icon">  </div>
                ...
                <li>
                    ...
                    <ul class="">
                        <li>
                            <a href="<?php echo e(url('/info_layanan_publik_1')); ?>" class="menu">
                                <div class="menu__icon">  </div>
                                <div class="menu__title"> Informasi yang wajib disediakan dan diumumkan secara berkala </div>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('/info_layanan_publik_2')); ?>" class="menu">
                                <div class="menu__icon">  </div>
                                <div class="menu__title"> Informasi yang wajib diumumkan secara serta - merta </div>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('/info_layanan_publik_3')); ?>" class="menu">
                                <div class="menu__icon">  </div>
                ...
                <li>
                    ...
                    <ul class="">
                        <li>
                            <a href="<?php echo e(url('/lp_prosedurp')); ?>" class="menu">
                                <div class="menu__icon">  </div>
                                <div class="menu__title"> Prosedur Permohonan </div>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('/lp_registrasip')); ?>" class="menu">
                                <div class="menu__icon">  </div>
                ...
                <li>
                    <a href="<?php echo e(url('/agenda')); ?>" class="menu">
                        <div class="menu__icon">  </div>
                        <div class="menu__title"> AGENDA </div>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(url('/faq')); ?>" class="menu">
                        <div class="menu__icon">  </div>
        ...
        <nav class="top-nav">
            <ul>
            <li>
                    <a href="<?php echo e(url('/beranda')); ?>" class="top-menu <?php if(request() -> segment(1) == 'beranda'): ?> top-menu--active <?php endif; ?>">
                ...
                <li>
                    <a href="<?php echo e(url('/profil')); ?>" class="top-menu <?php if(request() -> segment(1) == 'profil'): ?> top-menu--active <?php endif; ?>">
                        <div class="top-menu__icon">  </div>
                ...
                <li>
                    <a href="<?php echo e(url('/regulasi')); ?>" class="top-menu <?php if(request()->segment(1) == 'regulasi'): ?> top-menu--active <?php endif; ?>">
                        <div class="top-menu__icon">  </div>
                ...
                <li>
                    <a href="<?php echo e(url('/maklumat')); ?>" class="top-menu <?php if(request() -> segment(1) == 'maklumat'): ?> top-menu--active <?php endif; ?>">
                        <div class="top-menu__icon">  </div>
                ...
                <li>
                    <a href="javascript:;" class="top-menu <?php if(request() -> segment(1) == 'info_layanan_publik_1'  || request() -> segment(1) == 'info_layanan_publik_2' || request() -> segment(1) == 'info_layanan_publik_3'): ?> top-menu--active <?php endif; ?>">
                        <div class="top-menu__icon">  </div>
                    ...
                    <br>
                        <li>
                            <a href="<?php echo e(url('/info_layanan_publik_1')); ?>" class="top-menu">
                        ...
                        <br>
                        <li>
                            <a href="<?php echo e(url('/info_layanan_publik_2')); ?>" class="top-menu">
                        ...
                        <br>
                        <li>
                            <a href="<?php echo e(url('/info_layanan_publik_3')); ?>" class="top-menu">
                ...
                <li>
                <li>
                    <a href="javascript:;" class="top-menu <?php if(request() -> segment(1) == 'lp_prosedurp'  || request() -> segment(1) == 'lp_registrasip'): ?> top-menu--active <?php endif; ?>">
                        <div class="top-menu__icon">  </div>
                        <div class="top-menu__title"> LAYANAN PUBLIK <i data-feather="chevron-down" class="menu__sub-icon"></i> </div>
                    </a>
                    <ul class="">
                        <li>
                            <a href="<?php echo e(url('/lp_prosedurp')); ?>" class="top-menu">
                                <div class="top-menu__icon">  </div>
                                <div class="top-menu__title"> Prosedur Permohonan </div>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('/lp_registrasip')); ?>" class="top-menu">
                                <div class="top-menu__icon">  </div>
                ...
                <li>
                    <a href="<?php echo e(url('/agenda')); ?>" class="top-menu <?php if(request() -> segment(1) == 'agenda'): ?> top-menu--active <?php endif; ?>">
                        <div class="top-menu__icon">  </div>
                        <div class="top-menu__title"> AGENDA </div>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(url('/faq')); ?>" class="top-menu <?php if(request() -> segment(1) == 'faq'): ?> top-menu--active <?php endif; ?>">
                        <div class="top-menu__icon">  </div>
                ...
                <div class="col-span-12 xxl:col-span-9 grid grid-cols-12 gap-6">
                    ...
                    <div class="col-span-12 xl:col-span-8">
                        <div class="intro-y box p-5 mt-5 sm:mt-5 bg-blue-400 text-white" style="background-color: #1c3faa;">
                            <?php echo $__env->yieldContent('namehalaman'); ?>
                        </div>
                        
                        <div class="intro-y box p-5 mt-5 sm:mt-5">
                            <?php echo $__env->yieldContent('content'); ?>
                        </div>
                        <?php echo $__env->yieldContent('cardlp'); ?>
                    </div>
                    <!-- END: Official Store -->
...
</html><?php /**PATH C:\xampp\htdocs\plid\laravel\resources\views/layout.blade.php ENDPATH**/ ?>