...
<br>
            ...
            <tbody>
                 ...
                 <tr>
                     <td class="border-b dark:border-dark-5">3</td>
                     <td class="border-b dark:border-dark-5">Ikhtisar Laba Rugi</td>
                     <td class="border-b dark:border-dark-5"></td>
                     <td class="border-b dark:border-dark-5">
                        <a href="#" class="button w-24 inline-block mr-1 mb-2 bg-theme-1 text-white">Download</a>
                    </td>
                 ...
                 <tr>
                     <td class="border-b dark:border-dark-5">4</td>
                     <td class="border-b dark:border-dark-5">Laporan Program Kemitraan dan Bina Lingkungan Tahun 2019</td>
                     <td class="border-b dark:border-dark-5"></td>
                     <td class="border-b dark:border-dark-5">
                        <a href="#" class="button w-24 inline-block mr-1 mb-2 bg-theme-1 text-white">Download</a>
                    </td>
                 ...
                 <tr>
                     <td class="border-b dark:border-dark-5">5</td>
                     <td class="border-b dark:border-dark-5">Ringkasan Laporan Layanan Informasi Publik 2019-2020</td>
                     <td class="border-b dark:border-dark-5"></td>
                     <td class="border-b dark:border-dark-5">
                        <a href="#" class="button w-24 inline-block mr-1 mb-2 bg-theme-1 text-white">Download</a>
                    </td>
...
<br>
            ...
            <tbody>
                 <tr>
                     <td class="border-b dark:border-dark-5">1</td>
                     <td class="border-b dark:border-dark-5">Sistem dan Alokasi Remunerasi Dewan Komisaris dan Direksi</td>
                     <td class="border-b dark:border-dark-5"></td>
                     <td class="border-b dark:border-dark-5">
                        <a href="#" class="button w-24 inline-block mr-1 mb-2 bg-theme-1 text-white">Download</a>
                    </td>
...
<br>
            <h2 class="text-lg font-medium mr-auto">
                Penetapan Dewan Komisaris dan Direksi
            </h2>
                <table class="table mt-5">
                    <thead>
                        <tr class="bg-gray-200 text-gray-700">
...
<br>
            <h2 class="text-lg font-medium mr-auto">
              Informasi Tentang Profil PPID PT PAL Indonesia (Persero)
            </h2>
                <table class="table mt-5">
                    <thead>
                        <tr class="bg-gray-200 text-gray-700">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\plid\laravel\resources\views/info_layanan_publik_1.blade.php ENDPATH**/ ?>