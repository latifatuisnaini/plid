...
<div class="px-2">
  <div class="flex -mx-2">
    ...
    <img src="<?php echo e(asset('dist/images/gambar_beranda.jpg')); ?>">
    </div>
    ...
    <p class="mt-2 mb-2">
    1. <a href="<?php echo e(url('/info_layanan_publik_1')); ?>" class="no-underline hover:underline">Informasi yang wajib disediakan dan diumumkan secara berkala;</a>
    <br>
    2. <a href="<?php echo e(url('/info_layanan_publik_2')); ?>" class="no-underline hover:underline"> Informasi yang wajib disediakan dan diumumkan secara serta-merta;</a>
    <br>
    3. <a href="<?php echo e(url('/info_layanan_publik_3')); ?>" class="no-underline hover:underline"> Informasi yang wajib sedia setiap saat;</a>
    </p>
    <p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\plid\laravel\resources\views/beranda.blade.php ENDPATH**/ ?>