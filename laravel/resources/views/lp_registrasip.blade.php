		...
		<i>
            ...
            <div class="p-5" id="horizontal-form">
                <div class="preview">
                    ...
                    <div class="flex flex-col sm:flex-row items-center">
                        <label class="w-full sm:w-20 sm:text-left sm:mr-5">Jenis Identitas</label>
                        <select class="input w-full border mt-2 flex-1">
                            <option>KTP</option>
                    ...
                    <div class="flex flex-col sm:flex-row items-center">
                        <label class="w-full sm:w-20 sm:text-left sm:mr-5">Nomor Identitas</label>
                    ...
                    <div class="flex flex-col sm:flex-row items-center">
                        <label class="w-full sm:w-20 sm:text-left sm:mr-5">NPWP</label>
                            <input type="password" class="input w-full border mt-2 flex-1" >
                    </div>
                    <div class="flex flex-col sm:flex-row items-center">
                        <label class="w-full sm:w-20 sm:text-left sm:mr-5">Email *</label>
                            <input type="email" class="input w-full border mt-2 flex-1" >
                    </div>
                    <div class="flex flex-col sm:flex-row items-center">
                        <label class="w-full sm:w-20 sm:text-left sm:mr-5">Pekerjaan</label>
                            <input type="password" class="input w-full border mt-2 flex-1">
                    </div>
                    <div class="flex flex-col sm:flex-row items-center">
                        <label class="w-full sm:w-20 sm:text-left sm:mr-5">Alamat</label>
                            <textarea class="input w-full border mt-2 flex-1"></textarea>
                    </div>
                    <div class="flex flex-col sm:flex-row items-center">
                        <label class="w-full sm:w-20 sm:text-left sm:mr-5">No Telp</label>
                            <input type="password" class="input w-full border mt-2 flex-1">
                    </div>
                    <div class="flex flex-col sm:flex-row items-center">
                        <label class="w-full sm:w-20 sm:text-left sm:mr-5">No Fax</label>
                            <input type="password" class="input w-full border mt-2 flex-1">
                    </div>
                    <div class="flex flex-col sm:flex-row items-center">
                        <label class="w-full sm:w-20 sm:text-left sm:mr-5">Password</label>
                            <input type="password" class="input w-full border mt-2 flex-1">
                    </div>
